...
|hpx| drew inspiration from |tbb| to introduce the :hpx:func:`hpx::experimental::task_group`
feature. Therefore, utilizing :hpx:func:`hpx::experimental::task_group` provides an
...
-----------------------------
   ...
   ========================================  ===================================================================================================================
   :ref:`MPI_Allgather`                      :hpx:class:`hpx::collectives::all_gather`
   :ref:`MPI_Allreduce`                      :hpx:class:`hpx::collectives::all_reduce`
   :ref:`MPI_Alltoall`                       :hpx:class:`hpx::collectives::all_to_all`
   :ref:`MPI_Barrier`                        :hpx:class:`hpx::distributed::barrier`
   :ref:`MPI_Bcast`                          :hpx:class:`hpx::collectives::broadcast_to()` and :hpx:class:`hpx::collectives::broadcast_from()` used with :code:`get()`
   :ref:`MPI_Comm_size <MPI_Send_MPI_Recv>`  :hpx:class:`hpx::get_num_localities`
   :ref:`MPI_Comm_rank <MPI_Send_MPI_Recv>`  :hpx:class:`hpx::get_locality_id()`
   :ref:`MPI_Exscan`                         :hpx:class:`hpx::collectives::exclusive_scan()` used with :code:`get()`
   :ref:`MPI_Gather`                         :hpx:class:`hpx::collectives::gather_here()` and :hpx:class:`hpx::collectives::gather_there()` used with :code:`get()`
   :ref:`MPI_Irecv <MPI_Send_MPI_Recv>`      :hpx:class:`hpx::collectives::get()`
   :ref:`MPI_Isend <MPI_Send_MPI_Recv>`      :hpx:class:`hpx::collectives::set()`
   :ref:`MPI_Reduce`                         :hpx:class:`hpx::collectives::reduce_here` and :hpx:class:`hpx::collectives::reduce_there` used with :code:`get()`
   :ref:`MPI_Scan`                           :hpx:class:`hpx::collectives::inclusive_scan()` used with :code:`get()`
   :ref:`MPI_Scatter`                        :hpx:class:`hpx::collectives::scatter_to()` and :hpx:class:`hpx::collectives::scatter_from()`
   :ref:`MPI_Wait <MPI_Send_MPI_Recv>`       :hpx:class:`hpx::collectives::get()` used with a future i.e. :code:`setf.get()`
   ========================================  ===================================================================================================================

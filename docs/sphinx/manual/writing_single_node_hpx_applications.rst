...
:hpx:func:`hpx::future`, :hpx:func:`hpx::shared_future` and :hpx:func:`hpx::async`,
...
.. list-table:: Facilities extending ``std::future``
   ...
   * * unwrapping constructor for :hpx:func:`hpx::future`
...
|hpx| still supports calling :hpx:func:`hpx::experimental::task_block::run`

...
``init_rate`` using :hpx:class:`hpx::make_ready_future`.
...
:hpx:class:`hpx::make_ready_future`\ ``<double>`` returns a future containing
...
reassignment of ``principal`` using a :hpx:class:`hpx::dataflow`. A dataflow
